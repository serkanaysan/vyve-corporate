...
export default function HeroSection() {
  ...
  return (
    <section className="py-12 relative overflow-hidden dark:bg-[#171F2E]">
      <div className="max-w-[120rem] mx-auto relative">
        <div className="wrapper">
          <div className="max-w-[900px] mx-auto">
            <div className="text-center pb-8">
              ...
              />
              <h1 className="text-gray-700 mx-auto font-bold mb-4 text-4xl sm:text-[50px] dark:text-white/90 sm:leading-[64px] max-w-[880px]">
                {t(
                  "hero.description",
              ...
              <p className="max-w-[537px] text-center mx-auto dark:text-gray-400 text-gray-500 text-xs mt-2">
        ...
        {/* <div className="max-[1100px]:hidden">
          <Image
            ...
            className="absolute top-6 left-16 floating-1"
            alt=""
            width={170}
            height={44}
          />
          <Image
            ...
            className="absolute left-[145px] top-[224px] floating-2 max-[1240px]:left-[80px]"
            alt=""
            width={181}
            height={44}
          />
          <Image
            ...
            className="absolute right-16 top-[24px] floating-3"
            alt=""
            width={176}
            height={44}
          />
          <Image
            ...
            className="absolute top-[240px] right-[200px] floating-4 max-[1240px]:right-[80px] max-[1350px]:right-[150px] max-[1500px]:right-[200px]"
            alt=""
            width={179}
            height={44}
          />
