  ...
  const tabs: Tab[] = [
    {
      ...
      lightImage: '/images/tab-image/explorer-light.png',
      darkImage: '/images/tab-image/explorer.png',
                  ...
                  <Fragment key={tab.id}>
                    ...
                    >
                      {/* <img
                        ...
                        alt={tab.label}
                        className="h-[300px] rounded-2xl block dark:hidden object-contain"
                        style={{ width: 'auto' }}
                      /> */}
                    </div>
                    ...
                    >
                      {/* <img
                        ...
                        alt={tab.label}
                        className="h-[300px] rounded-2xl hidden dark:block object-contain"
                        style={{ width: 'auto' }}
                      /> */}
                    </div>
                  </Fragment>
